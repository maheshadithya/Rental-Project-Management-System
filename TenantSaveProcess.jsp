...
int i=stmt.executeUpdate("INSERT INTO tenant(first_name,second_name,gender,age,mobile,email,address)VALUES('"+first_name+"','"+second_name+"','"+gender+"','"+age+"','"+mobile+"','"+email+"','"+address+"')");
if(i>0){
out.println("Record Insert Success!");
session.setAttribute("RecordInsertSucess2","RecordInsertSuccess2");
